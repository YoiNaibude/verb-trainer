...
// ---------- Portuguese dataset ----------
const PT_DATA = {
  falar: { irregular: false, present: { "eu": "falo", "tu": "falas", "ele/ela/você": "fala", "nós": "falamos", "vós": "falais", "eles/elas/vocês": "falam" } },
  ser: { irregular: true, present: { "eu": "sou", "tu": "és", "ele/ela/você": "é", "nós": "somos", "vós": "sois", "eles/elas/vocês": "são" } },
  estar: { irregular: false, present: { "eu": "estou", "tu": "estás", "ele/ela/você": "está", "nós": "estamos", "vós": "estais", "eles/elas/vocês": "estão" } },

  ler: { irregular: true, present: { "eu": "leio", "tu": "lês", "ele/ela/você": "lê", "nós": "lemos", "vós": "ledes", "eles/elas/vocês": "leem" } },
  ver: { irregular: true, present: { "eu": "vejo", "tu": "vês", "ele/ela/você": "vê", "nós": "vemos", "vós": "vedes", "eles/elas/vocês": "veem" } },
  ter: { irregular: true, present: { "eu": "tenho", "tu": "tens", "ele/ela/você": "tem", "nós": "temos", "vós": "tendes", "eles/elas/vocês": "têm" } },
  fazer: { irregular: true, present: { "eu": "faço", "tu": "fazes", "ele/ela/você": "faz", "nós": "fazemos", "vós": "fazeis", "eles/elas/vocês": "fazem" } },
  ir: { irregular: true, present: { "eu": "vou", "tu": "vais", "ele/ela/você": "vai", "nós": "vamos", "vós": "ides", "eles/elas/vocês": "vão" } },
  poder: { irregular: true, present: { "eu": "posso", "tu": "podes", "ele/ela/você": "pode", "nós": "podemos", "vós": "podeis", "eles/elas/vocês": "podem" } },
  querer: { irregular: true, present: { "eu": "quero", "tu": "queres", "ele/ela/você": "quer", "nós": "queremos", "vós": "quereis", "eles/elas/vocês": "querem" } },
  saber: { irregular: true, present: { "eu": "sei", "tu": "sabes", "ele/ela/você": "sabe", "nós": "sabemos", "vós": "sabeis", "eles/elas/vocês": "sabem" } },
  "chamar-se": { irregular: false, present: { "eu": "me chamo", "tu": "te chamas", "ele/ela/você": "se chama", "nós": "nos chamamos", "vós": "vos chamais", "eles/elas/vocês": "se chamam" } },
  dizer: { irregular: true, present: { "eu": "digo", "tu": "dizes", "ele/ela/você": "diz", "nós": "dizemos", "vós": "dizeis", "eles/elas/vocês": "dizem" } },
  dar: { irregular: true, present: { "eu": "dou", "tu": "dás", "ele/ela/você": "dá", "nós": "damos", "vós": "dais", "eles/elas/vocês": "dão" } },
  subir: { irregular: false, present: { "eu": "subo", "tu": "sobes", "ele/ela/você": "sobe", "nós": "subimos", "vós": "subis", "eles/elas/vocês": "sobem" } },
  pôr: { irregular: true, present: { "eu": "ponho", "tu": "pões", "ele/ela/você": "põe", "nós": "pomos", "vós": "pondes", "eles/elas/vocês": "põem" } },
  trazer: { irregular: true, present: { "eu": "trago", "tu": "trazes", "ele/ela/você": "traz", "nós": "trazemos", "vós": "trazeis", "eles/elas/vocês": "trazem" } },
  vir: { irregular: true, present: { "eu": "venho", "tu": "vens", "ele/ela/você": "vem", "nós": "vimos", "vós": "vindes", "eles/elas/vocês": "vêm" } },
  haver: { irregular: true, present: { "eu": "hei", "tu": "hás", "ele/ela/você": "há", "nós": "havemos", "vós": "haveis", "eles/elas/vocês": "hão" } },
  dormir: { irregular: false, present: { "eu": "durmo", "tu": "dormes", "ele/ela/você": "dorme", "nós": "dormimos", "vós": "dormis", "eles/elas/vocês": "dormem" } },
  ouvir: { irregular: false, present: { "eu": "ouço", "tu": "ouves", "ele/ela/você": "ouve", "nós": "ouvimos", "vós": "ouvis", "eles/elas/vocês": "ouvem" } },
  preferir: { irregular: false, present: { "eu": "prefiro", "tu": "preferes", "ele/ela/você": "prefere", "nós": "preferimos", "vós": "preferis", "eles/elas/vocês": "preferem" } },
  sair: { irregular: true, present: { "eu": "saio", "tu": "sais", "ele/ela/você": "sai", "nós": "saímos", "vós": "saís", "eles/elas/vocês": "saem" } },
  rir: { irregular: true, present: { "eu": "rio", "tu": "ris", "ele/ela/você": "ri", "nós": "rimos", "vós": "rides", "eles/elas/vocês": "riem" } },
  cair: { irregular: true, present: { "eu": "caio", "tu": "cais", "ele/ela/você": "cai", "nós": "caímos", "vós": "caís", "eles/elas/vocês": "caem" } },
  perder: { irregular: true, present: { "eu": "perco", "tu": "perdes", "ele/ela/você": "perde", "nós": "perdemos", "vós": "perdeis", "eles/elas/vocês": "perdem" } },
  servir: { irregular: false, present: { "eu": "sirvo", "tu": "serves", "ele/ela/você": "serve", "nós": "servimos", "vós": "servis", "eles/elas/vocês": "servem" } },
  pedir: { irregular: false, present: { "eu": "peço", "tu": "pedes", "ele/ela/você": "pede", "nós": "pedimos", "vós": "pedis", "eles/elas/vocês": "pedem" } },
  passear: { irregular: true, present: { "eu": "passeio", "tu": "passeias", "ele/ela/você": "passeia", "nós": "passeamos", "vós": "passeais", "eles/elas/vocês": "passeiam" } },
};
...
const PERSONS = {
  ...
  pt: {
    present: ["eu", "tu", "ele/ela/você", "nós", "vós", "eles/elas/vocês"],
  },
};
